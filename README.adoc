...
to use for hexagram information. A translation file is a JSON, JSON5 or MJSON
file with a `.trans` extension that contains a table with all the information
text for each hexagram.
